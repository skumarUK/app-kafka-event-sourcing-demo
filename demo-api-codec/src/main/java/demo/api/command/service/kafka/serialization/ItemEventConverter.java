...
import demo.api.codec.kafka.events.serialization.*;
...
public class ItemEventConverter {
     ...
     *
     * @param event the domain event that ought to be converted
     * @return instance of {@code AvroItemEvent} that mirrors the domain event
     */
     ...
     *
     * @param event the Avro event that ought to be converted
     * @return instance of {@code ItemEvent} that mirrros the Avro event
     */
